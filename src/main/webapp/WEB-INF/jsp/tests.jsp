...
<html>
  ...
  <body>
    ...
    <a href="${s:mvcUrl('DC#reuestCalculator').arg(0, 'operant1').arg(1, 'operator').arg(2,'operant2').build()}">Calc</a>
    <a href="${s:mvcUrl('DC#requestMappingBunchExp').build()}">Exp</a>,
    <a href="${s:mvcUrl('DC#headers').build()}">Headers</a>
